(function (global, factory) {
    ...
    class ParticleGeometry extends THREE__namespace.BufferGeometry {
        isParticleGeometry = true;
        motionDirection = new THREE__namespace.Vector3(0, 1, 0);
        ...
        generateAttributes(count) {
            ...
            this.setAttribute('direction', new THREE__namespace.Float32BufferAttribute(directions, 3));
            this.setAttribute('random', new THREE__namespace.Float32BufferAttribute(randoms, 4));
        ...
        resetAttributes() {
            ...
            const v3 = new THREE__namespace.Vector3(0, 0, 0);
        ...
        updateAttributes(particle) {
            ...
            const direction = new THREE__namespace.Vector4(this.motionDirection.x, this.motionDirection.y, this.motionDirection.z, 0);
    ...
    class ParticleMaterial extends THREE__namespace.ShaderMaterial {
        ...
        set map(texture) {
            ...
            if (typeof texture === "string") {
                texture = new THREE__namespace.TextureLoader().load(texture);
            }
            texture.flipY = false;
        ...
        get rotationSpeed() {
            return this.uniforms.rotationSpeed.value * THREE__namespace.MathUtils.RAD2DEG;
        }
        set rotationSpeed(degree) {
            this.uniforms.rotationSpeed.value = degree * THREE__namespace.MathUtils.DEG2RAD;
        ...
        set rotationSpeedRandomRatio(ratio) {
            ...
            this.uniforms.rotationSpeedRandom.value *= THREE__namespace.MathUtils.DEG2RAD;
        }
        get startColor() {
        ...
        constructor() {
            ...
            this.blending = THREE__namespace.AdditiveBlending;
        ...
        initUniforms() {
            ...
            this.uniforms.gravityVector = { value: new THREE__namespace.Vector3() };
            ...
            this.uniforms.startColor = { value: new THREE__namespace.Color() };
            this.uniforms.endColor = { value: new THREE__namespace.Color() };
        }
        computePixelRatio(fov, pixelHeight) {
            const halfAngle = THREE__namespace.MathUtils.DEG2RAD * fov * 0.5;
        ...
        computeGravityVector(modelMatrix, isIndependent) {
            ...
            if (!isIndependent) {
                const m3 = new THREE__namespace.Matrix3();
    ...
    class Particle extends THREE__namespace.Points {
        isParticle = true;
        boundingSphere = null;
        modelMatrix = new THREE__namespace.Matrix4();
        ...
        registerRenderCallback() {
            ...
            const v2 = new THREE__namespace.Vector2();
            let fov;
            let pixelHeight;
            const modelMatrix = new THREE__namespace.Matrix4();
            let gravity;
            let isIndependent;
        ...
        computeBoundingSphere() {
            if (this.boundingSphere === null) {
                this.boundingSphere = new THREE__namespace.Sphere(undefined, -Infinity);
            }
            ...
            if (!this.independentMotion) {
                ...
                const v4 = new THREE__namespace.Vector4(direction.x, direction.y, direction.z, 0);
